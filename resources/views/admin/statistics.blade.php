                            ...
                            <div class="col-xl-12 col-lg-6 mb-4">
                                <div class="card card-stats mb-4 mb-xl-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Number of public
                                                    files:</h5>
                                                <span
                                                    class="h2 font-weight-bold mb-0">{{$statistics->public_files}}</span>
                                            </div>
                                            <div class="col-auto">
                            ...
                            <div class="col-xl-6 col-lg-6 mb-4">
                                <div class="card card-stats mb-4 mb-xl-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Number of private
                                                    files: </h5>
                                                <span
                                                    class="h2 font-weight-bold mb-0">{{$statistics->private_files}}</span>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape rounded-circle shadow">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Total number of
                                                    files: </h5>
                                                <span
                                                    class="h2 font-weight-bold mb-0">{{$statistics->public_files + $statistics->private_files}}</span>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape rounded-circle shadow">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                         fill="currentColor" class="bi bi-file-binary"
                                                         viewBox="0 0 16 16">
